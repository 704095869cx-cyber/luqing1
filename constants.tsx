...
export const Icons: Record<string, React.FC<{ className?: string }>> = {
  ...
  LuqingSystem: ({ className }) => <Sparkle className={className} weight="bold" />,
  LuqingNews: ({ className }) => <Newspaper className={className} weight="bold" />,
  LuqingMoments: ({ className }) => <Fire className={className} weight="bold" />,
  LuqingForum: ({ className }) => <ChatCircleText className={className} weight="bold" />,
  LuqingShop: ({ className }) => <PiggyBank className={className} weight="bold" />,
  LuqingMap: ({ className }) => <Compass className={className} weight="bold" />,
  LuqingAppBox: ({ className }) => <Notebook className={className} weight="bold" />,
};

const BASE_INSTALLED_APPS: AppConfig[] = [
...
const LUQING_APPS: AppConfig[] = [
  { id: AppID.LuqingSystem, name: '陆青系统', icon: 'LuqingSystem', color: 'rose' },
  { id: AppID.LuqingNews, name: '头条', icon: 'LuqingNews', color: 'orange' },
  { id: AppID.LuqingMoments, name: '朋友圈', icon: 'LuqingMoments', color: 'red' },
  { id: AppID.LuqingForum, name: '论坛', icon: 'LuqingForum', color: 'violet' },
  { id: AppID.LuqingShop, name: '购物', icon: 'LuqingShop', color: 'lime' },
  { id: AppID.LuqingMap, name: '地图', icon: 'LuqingMap', color: 'cyan' },
  { id: AppID.LuqingAppBox, name: '应用箱', icon: 'LuqingAppBox', color: 'indigo' },
];

export const INSTALLED_APPS: AppConfig[] = [
  ...BASE_INSTALLED_APPS.slice(0, 2),
  ...LUQING_APPS,
  ...BASE_INSTALLED_APPS.slice(2),
];
